...
function htmlend()
{
  ...
  <p class="fs-6 m-2 p-2">&copy; 2023 Copyright Thomas Netusil <a href="https://github.com/thomas-wien/BE18-CR5-NetusilThomas" target="_blank" rel="noopener noreferrer">Github for code and Admin Access</a></p>
</footer>
</body>
  </html>';
}
...
function getCon()
{
  ...
  $connect = DBConnection::getInstance(HOST, USER, PASS, DB);
  return $connect;
}
