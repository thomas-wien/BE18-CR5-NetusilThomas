...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 01. Apr 2023 um 14:10
...
INSERT INTO `animal` (`id`, `animal_name`, `breed`, `age`, `short_description`, `animal_type`, `picture`, `vaccines`, `adopted_from`, `adoption_date`, `available`, `fk_created_by_user`, `animal_last_modified`, `deleted`) VALUES
(13, 'Pengi', 'African Black-footed Penguin', 2, 'HABITAT Rocky ocean coasts\r\nDIET Fish, including sardines and anchovies, as well as squid and crustaceans\r\nTHREATS Habitat loss, overfishing, coastal development\r\nINTERESTING FACTS The African penguin is the only penguin species breeding on the African continent.', 'small', 'avatar.png', 'H5n1', 0, '0000-00-00', 'yes', 1, '2023-04-01 05:41:59', 'no'),
(14, 'Pengi', 'African Black-footed Penguin', 25, 'HABITAT Rocky ocean coasts\r\nDIET Fish, including sardines and anchovies, as well as squid and crustaceans\r\nTHREATS Habitat loss, overfishing, coastal development\r\nINTERESTING FACTS The African penguin is the only penguin species breeding on the African continent.', 'small', '641e8a39c5d08.jpg', 'H5n1', 0, '0000-00-00', 'yes', 1, '2023-04-01 11:57:05', 'no'),
...
(16, 'Painted Wolf', 'African Wild Dog', 6, 'HABITAT Forests, grasslands, deserts\r\nDIET Ruminants, such as gazelles\r\nTHREATS Habitat loss, disease, human-wildlife conflict\r\nINTERESTING FACTS African wild dog pups are cared for and raised by the entire pack.', 'small', '641e8c5df0907.jpg', 'rabies', 0, '0000-00-00', 'yes', 1, '2023-04-01 08:51:08', 'no'),
(17, 'Willy', 'Beluga Whale', 6, 'HABITAT Arctic Ocean and its nearby seas in the Northern Hemisphere\r\nDIET A variety of fish species, such as salmon and herring, as well as shrimp, crabs, and mollusks\r\nTHREATS Climate change, industrial development\r\nINTERESTING FACTS Like the closely related narwhal, beluga whales lack a dorsal fin, an adaptation that helps them conserve heat in their Arctic home.', 'large', '641e9a408c6db.webp', 'none', 0, '0000-00-00', 'yes', 1, '2023-04-01 06:41:12', 'no'),
(18, 'Daffy', 'Cheetah', 16, 'HABITAT Savannas and grasslands of sub-Saharan Africa\r\nDIET Ungulates (hoofed animals) such as gazelles, impalas, and wildebeest calves\r\nTHREATS Hunting, habitat loss, and the decline of prey species\r\nINTERESTING FACTS Cheetah mothers raise their young in isolation. They move their litter—usually two to six cubs—every four days to prevent a buildup of scent that predators can track.', 'large', '641e9b9979ae5.jpg', 'anti-rabies', 3, '2010-01-15', 'no', 1, '2023-04-01 12:06:33', 'no'),
...
(20, 'Cocquina', 'Fennec Fox', 5, 'HABITAT North Africa to North Sinai\r\nDIET Primarily grasshoppers and locusts but also other insects, rodents, birds, lizards, and roots\r\nTHREATS Trapping for the commercial trade\r\nINTERESTING FACTS The fennec fox’s ears allow for excellent hearing, its primary sense for hunting.', 'small', '641e92946bc87.webp', 'anti-rabies', 5, '2018-08-21', 'no', 1, '2023-04-01 12:07:36', 'no'),
(21, 'Bubbles', 'Flamingo', 13, 'HABITAT Shallow saltwater or brackish waters\r\nDIET Algae, shrimp\r\nTHREATS Habitat loss\r\nINTERESTING FACTS Flamingos’ unique bills help them feed by plunging their heads into the water upside-down and filtering the water for shrimp, which in turn gives the flamingo its bright pink color.', 'large', '641e93eb1decb.webp', 'H5n1', 0, '0000-00-00', 'yes', 1, '2023-04-01 11:57:16', 'no'),
...
(25, 'Dracula', 'Flying Fox', 3, 'HABITAT Forests\r\nDIET Nectar, pollen, fruit\r\nTHREATS Habitat loss\r\nINTERESTING FACTS Dipping their heads into flowering plants, flying foxes use their long tongues to extract pollen and nectar. The pollen that inadvertently collects on their fur is then transferred to the next flowers they visit.', 'small', '641e97ed208bf.webp', 'ABLV', 6, '2020-12-24', 'no', 1, '2023-04-01 12:09:13', 'no');
